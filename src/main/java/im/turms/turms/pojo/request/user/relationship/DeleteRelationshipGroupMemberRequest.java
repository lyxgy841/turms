...
private static final long serialVersionUID = 0L;
  ...
  private static final im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest();
  }
  ...
  getDescriptor() {
    return im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequestOuterClass.internal_static_im_turms_proto_DeleteRelationshipGroupMemberRequest_descriptor;
  }
  ...
  public static im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest parseFrom(
  ...
  public static im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest parseFrom(java.io.InputStream input)
          throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
  }

  public static im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest prototype) {
  ...
  public static im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest getDefaultInstance() {
  ...
  internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequestOuterClass.internal_static_im_turms_proto_DeleteRelationshipGroupMemberRequest_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                    im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest.class, im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest other = (im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest) obj;
  ...
  @java.lang.Override
  public im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest getDefaultInstanceForType() {
    return DEFAULT_INSTANCE;
  }
  ...
  public static final class Builder extends
          ...
          im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequestOrBuilder {
    // Construct using im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest getDefaultInstanceForType() {
      return im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest build() {
      im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest buildPartial() {
      im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest result = new im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest) {
        return mergeFrom((im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest) other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest other) {
      if (other == im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest.getDefaultInstance())
        return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.request.user.relationship.DeleteRelationshipGroupMemberRequest) e.getUnfinishedMessage();
