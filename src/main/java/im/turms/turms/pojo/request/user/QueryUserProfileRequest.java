...
private static final long serialVersionUID = 0L;
  ...
  private static final im.turms.turms.pojo.request.user.QueryUserProfileRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.request.user.QueryUserProfileRequest();
  }
  ...
  getDescriptor() {
    return im.turms.turms.pojo.request.user.QueryUserProfileRequestOuterClass.internal_static_im_turms_proto_QueryUserProfileRequest_descriptor;
  }
  ...
  public static im.turms.turms.pojo.request.user.QueryUserProfileRequest parseFrom(
  ...
  public static im.turms.turms.pojo.request.user.QueryUserProfileRequest parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static im.turms.turms.pojo.request.user.QueryUserProfileRequest parseFrom(java.io.InputStream input)
          throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.request.user.QueryUserProfileRequest parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
  }

  public static im.turms.turms.pojo.request.user.QueryUserProfileRequest parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.request.user.QueryUserProfileRequest prototype) {
  ...
  public static im.turms.turms.pojo.request.user.QueryUserProfileRequest getDefaultInstance() {
  ...
  internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.request.user.QueryUserProfileRequestOuterClass.internal_static_im_turms_proto_QueryUserProfileRequest_fieldAccessorTable
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.request.user.QueryUserProfileRequest)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.request.user.QueryUserProfileRequest other = (im.turms.turms.pojo.request.user.QueryUserProfileRequest) obj;
  ...
  @java.lang.Override
  public im.turms.turms.pojo.request.user.QueryUserProfileRequest getDefaultInstanceForType() {
    return DEFAULT_INSTANCE;
  }
  ...
  public static final class Builder extends
          ...
          im.turms.turms.pojo.request.user.QueryUserProfileRequestOrBuilder {
    // Construct using im.turms.turms.pojo.request.user.QueryUserProfileRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.user.QueryUserProfileRequest build() {
      im.turms.turms.pojo.request.user.QueryUserProfileRequest result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.user.QueryUserProfileRequest buildPartial() {
      im.turms.turms.pojo.request.user.QueryUserProfileRequest result = new im.turms.turms.pojo.request.user.QueryUserProfileRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.request.user.QueryUserProfileRequest) {
        return mergeFrom((im.turms.turms.pojo.request.user.QueryUserProfileRequest) other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.request.user.QueryUserProfileRequest other) {
      if (other == im.turms.turms.pojo.request.user.QueryUserProfileRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.request.user.QueryUserProfileRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.request.user.QueryUserProfileRequest) e.getUnfinishedMessage();
