...
private static final long serialVersionUID = 0L;
  ...
  private static final im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest();
  }
  ...
  getDescriptor() {
    return im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequestOuterClass.internal_static_im_turms_proto_QueryFriendRequestsRequest_descriptor;
  }
  ...
  public static im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest parseFrom(
  ...
  public static im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest parseFrom(java.io.InputStream input)
          throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
  }

  public static im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest prototype) {
  ...
  public static im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest getDefaultInstance() {
  ...
  internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequestOuterClass.internal_static_im_turms_proto_QueryFriendRequestsRequest_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                    im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest.class, im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest other = (im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest) obj;
  ...
  @java.lang.Override
  public im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest getDefaultInstanceForType() {
    return DEFAULT_INSTANCE;
  }
  ...
  public static final class Builder extends
          ...
          im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequestOrBuilder {
    // Construct using im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest build() {
      im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest buildPartial() {
      im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest result = new im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest(this);
      if (lastUpdatedDateBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest) {
        return mergeFrom((im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest) other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest other) {
      if (other == im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest.getDefaultInstance())
        return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.request.user.relationship.QueryFriendRequestsRequest) e.getUnfinishedMessage();
