...
private static final long serialVersionUID = 0L;
  ...
  private static final im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest();
  }
   ...
   */
  public im.turms.turms.constant.ResponseAction getResponseAction() {
    @SuppressWarnings("deprecation")
    im.turms.turms.constant.ResponseAction result = im.turms.turms.constant.ResponseAction.valueOf(responseAction_);
    return result == null ? im.turms.turms.constant.ResponseAction.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (responseAction_ != im.turms.turms.constant.ResponseAction.ACCEPT.getNumber()) {
  ...
  getDescriptor() {
    return im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequestOuterClass.internal_static_im_turms_proto_UpdateFriendRequestRequest_descriptor;
  }
  ...
  public static im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest parseFrom(
  ...
  public static im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest parseFrom(java.io.InputStream input)
          throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
  }

  public static im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest prototype) {
  ...
  public static im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest getDefaultInstance() {
  ...
  internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequestOuterClass.internal_static_im_turms_proto_UpdateFriendRequestRequest_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                    im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest.class, im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest other = (im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest) obj;
  ...
  @java.lang.Override
  public im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest getDefaultInstanceForType() {
    return DEFAULT_INSTANCE;
  }
  ...
  public static final class Builder extends
          ...
          im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequestOrBuilder {
    // Construct using im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest build() {
      im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest buildPartial() {
      im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest result = new im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest) {
        return mergeFrom((im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest) other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest other) {
      if (other == im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest.getDefaultInstance())
        return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.request.user.relationship.UpdateFriendRequestRequest) e.getUnfinishedMessage();
     ...
     * @return This builder for chaining.
     */
    public Builder setResponseAction(im.turms.turms.constant.ResponseAction value) {
      if (value == null) {
