...
private static final long serialVersionUID = 0L;
  ...
  private static final im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest();
  }
  ...
  getDescriptor() {
    return im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequestOuterClass.internal_static_im_turms_proto_QueryUsersIdsNearbyRequest_descriptor;
  }
  ...
  public static im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest parseFrom(
  ...
  public static im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest parseFrom(java.io.InputStream input)
          throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
  }

  public static im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest prototype) {
  ...
  public static im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest getDefaultInstance() {
  ...
  internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequestOuterClass.internal_static_im_turms_proto_QueryUsersIdsNearbyRequest_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                    im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest.class, im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest other = (im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest) obj;
  ...
  @java.lang.Override
  public im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest getDefaultInstanceForType() {
    return DEFAULT_INSTANCE;
  }
  ...
  public static final class Builder extends
          ...
          im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequestOrBuilder {
    // Construct using im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest build() {
      im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest buildPartial() {
      im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest result = new im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest) {
        return mergeFrom((im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest) other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest other) {
      if (other == im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.request.user.QueryUsersIdsNearbyRequest) e.getUnfinishedMessage();
