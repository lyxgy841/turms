...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.message.QueryPendingMessagesWithTotalRequest build() {
      im.turms.turms.pojo.request.message.QueryPendingMessagesWithTotalRequest result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.request.message.QueryPendingMessagesWithTotalRequest buildPartial() {
      im.turms.turms.pojo.request.message.QueryPendingMessagesWithTotalRequest result = new im.turms.turms.pojo.request.message.QueryPendingMessagesWithTotalRequest(this);
      if (sizeBuilder_ == null) {
        result.size_ = size_;
      } else {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.request.message.QueryPendingMessagesWithTotalRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.request.message.QueryPendingMessagesWithTotalRequest) e.getUnfinishedMessage();
