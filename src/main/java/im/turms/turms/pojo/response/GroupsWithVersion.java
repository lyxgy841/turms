...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              groups_ = new java.util.ArrayList<im.turms.turms.pojo.dto.Group>();
              mutable_bitField0_ |= 0x00000001;
            }
            groups_.add(
                input.readMessage(im.turms.turms.pojo.dto.Group.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return im.turms.turms.pojo.response.GroupsWithVersionOuterClass.internal_static_im_turms_proto_GroupsWithVersion_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.response.GroupsWithVersionOuterClass.internal_static_im_turms_proto_GroupsWithVersion_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.turms.pojo.response.GroupsWithVersion.class, im.turms.turms.pojo.response.GroupsWithVersion.Builder.class);
  }

  public static final int GROUPS_FIELD_NUMBER = 1;
  private java.util.List<im.turms.turms.pojo.dto.Group> groups_;
  /**
   * <code>repeated .im.turms.proto.Group groups = 1;</code>
   */
  public java.util.List<im.turms.turms.pojo.dto.Group> getGroupsList() {
    return groups_;
  }
  /**
   * <code>repeated .im.turms.proto.Group groups = 1;</code>
   */
  public java.util.List<? extends im.turms.turms.pojo.dto.GroupOrBuilder>
   ...
   * <code>repeated .im.turms.proto.Group groups = 1;</code>
   */
  public im.turms.turms.pojo.dto.Group getGroups(int index) {
    return groups_.get(index);
  }
  /**
   * <code>repeated .im.turms.proto.Group groups = 1;</code>
   */
  public im.turms.turms.pojo.dto.GroupOrBuilder getGroupsOrBuilder(
      int index) {
    return groups_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.response.GroupsWithVersion)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.response.GroupsWithVersion other = (im.turms.turms.pojo.response.GroupsWithVersion) obj;
  ...
  public static im.turms.turms.pojo.response.GroupsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.GroupsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.turms.pojo.response.GroupsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.GroupsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.response.GroupsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.turms.turms.pojo.response.GroupsWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.response.GroupsWithVersion prototype) {
  ...
  public static final class Builder extends
      ...
      im.turms.turms.pojo.response.GroupsWithVersionOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return im.turms.turms.pojo.response.GroupsWithVersionOuterClass.internal_static_im_turms_proto_GroupsWithVersion_descriptor;
    }
    ...
    // Construct using im.turms.turms.pojo.response.GroupsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.GroupsWithVersion getDefaultInstanceForType() {
      return im.turms.turms.pojo.response.GroupsWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.turms.pojo.response.GroupsWithVersion build() {
      im.turms.turms.pojo.response.GroupsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.GroupsWithVersion buildPartial() {
      im.turms.turms.pojo.response.GroupsWithVersion result = new im.turms.turms.pojo.response.GroupsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.response.GroupsWithVersion) {
        return mergeFrom((im.turms.turms.pojo.response.GroupsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.response.GroupsWithVersion other) {
      if (other == im.turms.turms.pojo.response.GroupsWithVersion.getDefaultInstance()) return this;
      if (groupsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.response.GroupsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.response.GroupsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureGroupsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        groups_ = new java.util.ArrayList<im.turms.turms.pojo.dto.Group>(groups_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.Group, im.turms.turms.pojo.dto.Group.Builder, im.turms.turms.pojo.dto.GroupOrBuilder> groupsBuilder_;
    ...
    public Builder setGroups(
        int index, im.turms.turms.pojo.dto.Group value) {
      if (groupsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setGroups(
        int index, im.turms.turms.pojo.dto.Group.Builder builderForValue) {
      if (groupsBuilder_ == null) {
        ensureGroupsIsMutable();
     ...
     * <code>repeated .im.turms.proto.Group groups = 1;</code>
     */
    public Builder addGroups(im.turms.turms.pojo.dto.Group value) {
      if (groupsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addGroups(
        im.turms.turms.pojo.dto.Group.Builder builderForValue) {
      if (groupsBuilder_ == null) {
        ensureGroupsIsMutable();
    ...
    public Builder addAllGroups(
        java.lang.Iterable<? extends im.turms.turms.pojo.dto.Group> values) {
      if (groupsBuilder_ == null) {
        ensureGroupsIsMutable();
     ...
     * <code>repeated .im.turms.proto.Group groups = 1;</code>
     */
    public im.turms.turms.pojo.dto.Group.Builder getGroupsBuilder(
        int index) {
     ...
     * <code>repeated .im.turms.proto.Group groups = 1;</code>
     */
    public im.turms.turms.pojo.dto.Group.Builder addGroupsBuilder() {
      return getGroupsFieldBuilder().addBuilder(
          im.turms.turms.pojo.dto.Group.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.Group groups = 1;</code>
     */
    public im.turms.turms.pojo.dto.Group.Builder addGroupsBuilder(
        int index) {
      return getGroupsFieldBuilder().addBuilder(
          index, im.turms.turms.pojo.dto.Group.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.Group groups = 1;</code>
     */
    public java.util.List<im.turms.turms.pojo.dto.Group.Builder>
         getGroupsBuilderList() {
      return getGroupsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.Group, im.turms.turms.pojo.dto.Group.Builder, im.turms.turms.pojo.dto.GroupOrBuilder>
        getGroupsFieldBuilder() {
      if (groupsBuilder_ == null) {
  ...
  private static final im.turms.turms.pojo.response.GroupsWithVersion DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.response.GroupsWithVersion();
  }

  public static im.turms.turms.pojo.response.GroupsWithVersion getDefaultInstance() {
