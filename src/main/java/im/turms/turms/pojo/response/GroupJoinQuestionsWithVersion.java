...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              groupJoinQuestions_ = new java.util.ArrayList<im.turms.turms.pojo.dto.GroupJoinQuestion>();
              mutable_bitField0_ |= 0x00000001;
            }
            groupJoinQuestions_.add(
                input.readMessage(im.turms.turms.pojo.dto.GroupJoinQuestion.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return im.turms.turms.pojo.response.GroupJoinQuestionsWithVersionOuterClass.internal_static_im_turms_proto_GroupJoinQuestionsWithVersion_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.response.GroupJoinQuestionsWithVersionOuterClass.internal_static_im_turms_proto_GroupJoinQuestionsWithVersion_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion.class, im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion.Builder.class);
  }

  public static final int GROUP_JOIN_QUESTIONS_FIELD_NUMBER = 1;
  private java.util.List<im.turms.turms.pojo.dto.GroupJoinQuestion> groupJoinQuestions_;
  /**
   * <code>repeated .im.turms.proto.GroupJoinQuestion group_join_questions = 1;</code>
   */
  public java.util.List<im.turms.turms.pojo.dto.GroupJoinQuestion> getGroupJoinQuestionsList() {
    return groupJoinQuestions_;
  }
  /**
   * <code>repeated .im.turms.proto.GroupJoinQuestion group_join_questions = 1;</code>
   */
  public java.util.List<? extends im.turms.turms.pojo.dto.GroupJoinQuestionOrBuilder> 
   ...
   * <code>repeated .im.turms.proto.GroupJoinQuestion group_join_questions = 1;</code>
   */
  public im.turms.turms.pojo.dto.GroupJoinQuestion getGroupJoinQuestions(int index) {
    return groupJoinQuestions_.get(index);
  }
  /**
   * <code>repeated .im.turms.proto.GroupJoinQuestion group_join_questions = 1;</code>
   */
  public im.turms.turms.pojo.dto.GroupJoinQuestionOrBuilder getGroupJoinQuestionsOrBuilder(
      int index) {
    return groupJoinQuestions_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion other = (im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion) obj;
  ...
  public static im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion prototype) {
  ...
  public static final class Builder extends
      ...
      im.turms.turms.pojo.response.GroupJoinQuestionsWithVersionOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return im.turms.turms.pojo.response.GroupJoinQuestionsWithVersionOuterClass.internal_static_im_turms_proto_GroupJoinQuestionsWithVersion_descriptor;
    }
    ...
    // Construct using im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion getDefaultInstanceForType() {
      return im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion build() {
      im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion buildPartial() {
      im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion result = new im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion) {
        return mergeFrom((im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion other) {
      if (other == im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion.getDefaultInstance()) return this;
      if (groupJoinQuestionsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureGroupJoinQuestionsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        groupJoinQuestions_ = new java.util.ArrayList<im.turms.turms.pojo.dto.GroupJoinQuestion>(groupJoinQuestions_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.GroupJoinQuestion, im.turms.turms.pojo.dto.GroupJoinQuestion.Builder, im.turms.turms.pojo.dto.GroupJoinQuestionOrBuilder> groupJoinQuestionsBuilder_;
    ...
    public Builder setGroupJoinQuestions(
        int index, im.turms.turms.pojo.dto.GroupJoinQuestion value) {
      if (groupJoinQuestionsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setGroupJoinQuestions(
        int index, im.turms.turms.pojo.dto.GroupJoinQuestion.Builder builderForValue) {
      if (groupJoinQuestionsBuilder_ == null) {
        ensureGroupJoinQuestionsIsMutable();
     ...
     * <code>repeated .im.turms.proto.GroupJoinQuestion group_join_questions = 1;</code>
     */
    public Builder addGroupJoinQuestions(im.turms.turms.pojo.dto.GroupJoinQuestion value) {
      if (groupJoinQuestionsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addGroupJoinQuestions(
        im.turms.turms.pojo.dto.GroupJoinQuestion.Builder builderForValue) {
      if (groupJoinQuestionsBuilder_ == null) {
        ensureGroupJoinQuestionsIsMutable();
    ...
    public Builder addAllGroupJoinQuestions(
        java.lang.Iterable<? extends im.turms.turms.pojo.dto.GroupJoinQuestion> values) {
      if (groupJoinQuestionsBuilder_ == null) {
        ensureGroupJoinQuestionsIsMutable();
     ...
     * <code>repeated .im.turms.proto.GroupJoinQuestion group_join_questions = 1;</code>
     */
    public im.turms.turms.pojo.dto.GroupJoinQuestion.Builder getGroupJoinQuestionsBuilder(
        int index) {
     ...
     * <code>repeated .im.turms.proto.GroupJoinQuestion group_join_questions = 1;</code>
     */
    public im.turms.turms.pojo.dto.GroupJoinQuestion.Builder addGroupJoinQuestionsBuilder() {
      return getGroupJoinQuestionsFieldBuilder().addBuilder(
          im.turms.turms.pojo.dto.GroupJoinQuestion.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.GroupJoinQuestion group_join_questions = 1;</code>
     */
    public im.turms.turms.pojo.dto.GroupJoinQuestion.Builder addGroupJoinQuestionsBuilder(
        int index) {
      return getGroupJoinQuestionsFieldBuilder().addBuilder(
          index, im.turms.turms.pojo.dto.GroupJoinQuestion.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.GroupJoinQuestion group_join_questions = 1;</code>
     */
    public java.util.List<im.turms.turms.pojo.dto.GroupJoinQuestion.Builder> 
         getGroupJoinQuestionsBuilderList() {
      return getGroupJoinQuestionsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.GroupJoinQuestion, im.turms.turms.pojo.dto.GroupJoinQuestion.Builder, im.turms.turms.pojo.dto.GroupJoinQuestionOrBuilder> 
        getGroupJoinQuestionsFieldBuilder() {
      if (groupJoinQuestionsBuilder_ == null) {
  ...
  private static final im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion();
  }

  public static im.turms.turms.pojo.response.GroupJoinQuestionsWithVersion getDefaultInstance() {
