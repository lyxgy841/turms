...
public interface UserRelationshipsWithVersionOrBuilder extends
   ...
   */
  java.util.List<im.turms.turms.pojo.dto.UserRelationship> 
      getUserRelationshipsList();
  /**
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  im.turms.turms.pojo.dto.UserRelationship getUserRelationships(int index);
  /**
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
   ...
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  java.util.List<? extends im.turms.turms.pojo.dto.UserRelationshipOrBuilder> 
      getUserRelationshipsOrBuilderList();
  /**
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  im.turms.turms.pojo.dto.UserRelationshipOrBuilder getUserRelationshipsOrBuilder(
      int index);
