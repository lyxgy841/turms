...
public interface GroupJoinRequestsWithVersionOrBuilder extends
   ...
   */
  java.util.List<im.turms.turms.pojo.dto.GroupJoinRequest> 
      getGroupJoinRequestsList();
  /**
   * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
   */
  im.turms.turms.pojo.dto.GroupJoinRequest getGroupJoinRequests(int index);
  /**
   * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
   */
   ...
   * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
   */
  java.util.List<? extends im.turms.turms.pojo.dto.GroupJoinRequestOrBuilder> 
      getGroupJoinRequestsOrBuilderList();
  /**
   * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
   */
  im.turms.turms.pojo.dto.GroupJoinRequestOrBuilder getGroupJoinRequestsOrBuilder(
      int index);
