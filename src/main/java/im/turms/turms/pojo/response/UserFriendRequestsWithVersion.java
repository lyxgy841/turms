...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userFriendRequests_ = new java.util.ArrayList<im.turms.turms.pojo.dto.UserFriendRequest>();
              mutable_bitField0_ |= 0x00000001;
            }
            userFriendRequests_.add(
                input.readMessage(im.turms.turms.pojo.dto.UserFriendRequest.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return im.turms.turms.pojo.response.UserFriendRequestsWithVersionOuterClass.internal_static_im_turms_proto_UserFriendRequestsWithVersion_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.response.UserFriendRequestsWithVersionOuterClass.internal_static_im_turms_proto_UserFriendRequestsWithVersion_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.turms.pojo.response.UserFriendRequestsWithVersion.class, im.turms.turms.pojo.response.UserFriendRequestsWithVersion.Builder.class);
  }

  public static final int USER_FRIEND_REQUESTS_FIELD_NUMBER = 1;
  private java.util.List<im.turms.turms.pojo.dto.UserFriendRequest> userFriendRequests_;
  /**
   * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
   */
  public java.util.List<im.turms.turms.pojo.dto.UserFriendRequest> getUserFriendRequestsList() {
    return userFriendRequests_;
  }
  /**
   * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
   */
  public java.util.List<? extends im.turms.turms.pojo.dto.UserFriendRequestOrBuilder>
   ...
   * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
   */
  public im.turms.turms.pojo.dto.UserFriendRequest getUserFriendRequests(int index) {
    return userFriendRequests_.get(index);
  }
  /**
   * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
   */
  public im.turms.turms.pojo.dto.UserFriendRequestOrBuilder getUserFriendRequestsOrBuilder(
      int index) {
    return userFriendRequests_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.response.UserFriendRequestsWithVersion)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.response.UserFriendRequestsWithVersion other = (im.turms.turms.pojo.response.UserFriendRequestsWithVersion) obj;
  ...
  public static im.turms.turms.pojo.response.UserFriendRequestsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.UserFriendRequestsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.turms.pojo.response.UserFriendRequestsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.UserFriendRequestsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.response.UserFriendRequestsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.turms.turms.pojo.response.UserFriendRequestsWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.response.UserFriendRequestsWithVersion prototype) {
  ...
  public static final class Builder extends
      ...
      im.turms.turms.pojo.response.UserFriendRequestsWithVersionOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return im.turms.turms.pojo.response.UserFriendRequestsWithVersionOuterClass.internal_static_im_turms_proto_UserFriendRequestsWithVersion_descriptor;
    }
    ...
    // Construct using im.turms.turms.pojo.response.UserFriendRequestsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.UserFriendRequestsWithVersion getDefaultInstanceForType() {
      return im.turms.turms.pojo.response.UserFriendRequestsWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.turms.pojo.response.UserFriendRequestsWithVersion build() {
      im.turms.turms.pojo.response.UserFriendRequestsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.UserFriendRequestsWithVersion buildPartial() {
      im.turms.turms.pojo.response.UserFriendRequestsWithVersion result = new im.turms.turms.pojo.response.UserFriendRequestsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.response.UserFriendRequestsWithVersion) {
        return mergeFrom((im.turms.turms.pojo.response.UserFriendRequestsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.response.UserFriendRequestsWithVersion other) {
      if (other == im.turms.turms.pojo.response.UserFriendRequestsWithVersion.getDefaultInstance()) return this;
      if (userFriendRequestsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.response.UserFriendRequestsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.response.UserFriendRequestsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureUserFriendRequestsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        userFriendRequests_ = new java.util.ArrayList<im.turms.turms.pojo.dto.UserFriendRequest>(userFriendRequests_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.UserFriendRequest, im.turms.turms.pojo.dto.UserFriendRequest.Builder, im.turms.turms.pojo.dto.UserFriendRequestOrBuilder> userFriendRequestsBuilder_;
    ...
    public Builder setUserFriendRequests(
        int index, im.turms.turms.pojo.dto.UserFriendRequest value) {
      if (userFriendRequestsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setUserFriendRequests(
        int index, im.turms.turms.pojo.dto.UserFriendRequest.Builder builderForValue) {
      if (userFriendRequestsBuilder_ == null) {
        ensureUserFriendRequestsIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public Builder addUserFriendRequests(im.turms.turms.pojo.dto.UserFriendRequest value) {
      if (userFriendRequestsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addUserFriendRequests(
        im.turms.turms.pojo.dto.UserFriendRequest.Builder builderForValue) {
      if (userFriendRequestsBuilder_ == null) {
        ensureUserFriendRequestsIsMutable();
    ...
    public Builder addAllUserFriendRequests(
        java.lang.Iterable<? extends im.turms.turms.pojo.dto.UserFriendRequest> values) {
      if (userFriendRequestsBuilder_ == null) {
        ensureUserFriendRequestsIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public im.turms.turms.pojo.dto.UserFriendRequest.Builder getUserFriendRequestsBuilder(
        int index) {
     ...
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public im.turms.turms.pojo.dto.UserFriendRequest.Builder addUserFriendRequestsBuilder() {
      return getUserFriendRequestsFieldBuilder().addBuilder(
          im.turms.turms.pojo.dto.UserFriendRequest.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public im.turms.turms.pojo.dto.UserFriendRequest.Builder addUserFriendRequestsBuilder(
        int index) {
      return getUserFriendRequestsFieldBuilder().addBuilder(
          index, im.turms.turms.pojo.dto.UserFriendRequest.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public java.util.List<im.turms.turms.pojo.dto.UserFriendRequest.Builder>
         getUserFriendRequestsBuilderList() {
      return getUserFriendRequestsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.UserFriendRequest, im.turms.turms.pojo.dto.UserFriendRequest.Builder, im.turms.turms.pojo.dto.UserFriendRequestOrBuilder>
        getUserFriendRequestsFieldBuilder() {
      if (userFriendRequestsBuilder_ == null) {
  ...
  private static final im.turms.turms.pojo.response.UserFriendRequestsWithVersion DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.response.UserFriendRequestsWithVersion();
  }

  public static im.turms.turms.pojo.response.UserFriendRequestsWithVersion getDefaultInstance() {
