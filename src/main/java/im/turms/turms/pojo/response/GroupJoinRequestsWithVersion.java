...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              groupJoinRequests_ = new java.util.ArrayList<im.turms.turms.pojo.dto.GroupJoinRequest>();
              mutable_bitField0_ |= 0x00000001;
            }
            groupJoinRequests_.add(
                input.readMessage(im.turms.turms.pojo.dto.GroupJoinRequest.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return im.turms.turms.pojo.response.GroupJoinRequestsWithVersionOuterClass.internal_static_im_turms_proto_GroupJoinRequestsWithVersion_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.response.GroupJoinRequestsWithVersionOuterClass.internal_static_im_turms_proto_GroupJoinRequestsWithVersion_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.turms.pojo.response.GroupJoinRequestsWithVersion.class, im.turms.turms.pojo.response.GroupJoinRequestsWithVersion.Builder.class);
  }

  public static final int GROUP_JOIN_REQUESTS_FIELD_NUMBER = 1;
  private java.util.List<im.turms.turms.pojo.dto.GroupJoinRequest> groupJoinRequests_;
  /**
   * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
   */
  public java.util.List<im.turms.turms.pojo.dto.GroupJoinRequest> getGroupJoinRequestsList() {
    return groupJoinRequests_;
  }
  /**
   * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
   */
  public java.util.List<? extends im.turms.turms.pojo.dto.GroupJoinRequestOrBuilder>
   ...
   * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
   */
  public im.turms.turms.pojo.dto.GroupJoinRequest getGroupJoinRequests(int index) {
    return groupJoinRequests_.get(index);
  }
  /**
   * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
   */
  public im.turms.turms.pojo.dto.GroupJoinRequestOrBuilder getGroupJoinRequestsOrBuilder(
      int index) {
    return groupJoinRequests_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.response.GroupJoinRequestsWithVersion)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.response.GroupJoinRequestsWithVersion other = (im.turms.turms.pojo.response.GroupJoinRequestsWithVersion) obj;
  ...
  public static im.turms.turms.pojo.response.GroupJoinRequestsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.GroupJoinRequestsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.turms.pojo.response.GroupJoinRequestsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.GroupJoinRequestsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.response.GroupJoinRequestsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.turms.turms.pojo.response.GroupJoinRequestsWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.response.GroupJoinRequestsWithVersion prototype) {
  ...
  public static final class Builder extends
      ...
      im.turms.turms.pojo.response.GroupJoinRequestsWithVersionOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return im.turms.turms.pojo.response.GroupJoinRequestsWithVersionOuterClass.internal_static_im_turms_proto_GroupJoinRequestsWithVersion_descriptor;
    }
    ...
    // Construct using im.turms.turms.pojo.response.GroupJoinRequestsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.GroupJoinRequestsWithVersion getDefaultInstanceForType() {
      return im.turms.turms.pojo.response.GroupJoinRequestsWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.turms.pojo.response.GroupJoinRequestsWithVersion build() {
      im.turms.turms.pojo.response.GroupJoinRequestsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.GroupJoinRequestsWithVersion buildPartial() {
      im.turms.turms.pojo.response.GroupJoinRequestsWithVersion result = new im.turms.turms.pojo.response.GroupJoinRequestsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.response.GroupJoinRequestsWithVersion) {
        return mergeFrom((im.turms.turms.pojo.response.GroupJoinRequestsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.response.GroupJoinRequestsWithVersion other) {
      if (other == im.turms.turms.pojo.response.GroupJoinRequestsWithVersion.getDefaultInstance()) return this;
      if (groupJoinRequestsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.response.GroupJoinRequestsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.response.GroupJoinRequestsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureGroupJoinRequestsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        groupJoinRequests_ = new java.util.ArrayList<im.turms.turms.pojo.dto.GroupJoinRequest>(groupJoinRequests_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.GroupJoinRequest, im.turms.turms.pojo.dto.GroupJoinRequest.Builder, im.turms.turms.pojo.dto.GroupJoinRequestOrBuilder> groupJoinRequestsBuilder_;
    ...
    public Builder setGroupJoinRequests(
        int index, im.turms.turms.pojo.dto.GroupJoinRequest value) {
      if (groupJoinRequestsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setGroupJoinRequests(
        int index, im.turms.turms.pojo.dto.GroupJoinRequest.Builder builderForValue) {
      if (groupJoinRequestsBuilder_ == null) {
        ensureGroupJoinRequestsIsMutable();
     ...
     * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
     */
    public Builder addGroupJoinRequests(im.turms.turms.pojo.dto.GroupJoinRequest value) {
      if (groupJoinRequestsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addGroupJoinRequests(
        im.turms.turms.pojo.dto.GroupJoinRequest.Builder builderForValue) {
      if (groupJoinRequestsBuilder_ == null) {
        ensureGroupJoinRequestsIsMutable();
    ...
    public Builder addAllGroupJoinRequests(
        java.lang.Iterable<? extends im.turms.turms.pojo.dto.GroupJoinRequest> values) {
      if (groupJoinRequestsBuilder_ == null) {
        ensureGroupJoinRequestsIsMutable();
     ...
     * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
     */
    public im.turms.turms.pojo.dto.GroupJoinRequest.Builder getGroupJoinRequestsBuilder(
        int index) {
     ...
     * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
     */
    public im.turms.turms.pojo.dto.GroupJoinRequest.Builder addGroupJoinRequestsBuilder() {
      return getGroupJoinRequestsFieldBuilder().addBuilder(
          im.turms.turms.pojo.dto.GroupJoinRequest.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
     */
    public im.turms.turms.pojo.dto.GroupJoinRequest.Builder addGroupJoinRequestsBuilder(
        int index) {
      return getGroupJoinRequestsFieldBuilder().addBuilder(
          index, im.turms.turms.pojo.dto.GroupJoinRequest.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.GroupJoinRequest group_join_requests = 1;</code>
     */
    public java.util.List<im.turms.turms.pojo.dto.GroupJoinRequest.Builder>
         getGroupJoinRequestsBuilderList() {
      return getGroupJoinRequestsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.GroupJoinRequest, im.turms.turms.pojo.dto.GroupJoinRequest.Builder, im.turms.turms.pojo.dto.GroupJoinRequestOrBuilder>
        getGroupJoinRequestsFieldBuilder() {
      if (groupJoinRequestsBuilder_ == null) {
  ...
  private static final im.turms.turms.pojo.response.GroupJoinRequestsWithVersion DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.response.GroupJoinRequestsWithVersion();
  }

  public static im.turms.turms.pojo.response.GroupJoinRequestsWithVersion getDefaultInstance() {
