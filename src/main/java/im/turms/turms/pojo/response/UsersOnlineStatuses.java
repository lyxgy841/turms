...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userStatuses_ = new java.util.ArrayList<im.turms.turms.pojo.dto.UserStatusDetail>();
              mutable_bitField0_ |= 0x00000001;
            }
            userStatuses_.add(
                input.readMessage(im.turms.turms.pojo.dto.UserStatusDetail.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return im.turms.turms.pojo.response.UsersOnlineStatusesOuterClass.internal_static_im_turms_proto_UsersOnlineStatuses_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.response.UsersOnlineStatusesOuterClass.internal_static_im_turms_proto_UsersOnlineStatuses_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.turms.pojo.response.UsersOnlineStatuses.class, im.turms.turms.pojo.response.UsersOnlineStatuses.Builder.class);
  }

  public static final int USER_STATUSES_FIELD_NUMBER = 1;
  private java.util.List<im.turms.turms.pojo.dto.UserStatusDetail> userStatuses_;
  /**
   * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
   */
  public java.util.List<im.turms.turms.pojo.dto.UserStatusDetail> getUserStatusesList() {
   ...
   * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
   */
  public im.turms.turms.pojo.dto.UserStatusDetail getUserStatuses(int index) {
    return userStatuses_.get(index);
  }
  /**
   * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
   */
  public im.turms.turms.pojo.dto.UserStatusDetailOrBuilder getUserStatusesOrBuilder(
      int index) {
    return userStatuses_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.response.UsersOnlineStatuses)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.response.UsersOnlineStatuses other = (im.turms.turms.pojo.response.UsersOnlineStatuses) obj;
  ...
  public static im.turms.turms.pojo.response.UsersOnlineStatuses parseFrom(
  ...
  public static im.turms.turms.pojo.response.UsersOnlineStatuses parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.turms.pojo.response.UsersOnlineStatuses parseFrom(
  ...
  public static im.turms.turms.pojo.response.UsersOnlineStatuses parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.response.UsersOnlineStatuses parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.turms.turms.pojo.response.UsersOnlineStatuses parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.response.UsersOnlineStatuses prototype) {
  ...
  public static final class Builder extends
      ...
      im.turms.turms.pojo.response.UsersOnlineStatusesOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return im.turms.turms.pojo.response.UsersOnlineStatusesOuterClass.internal_static_im_turms_proto_UsersOnlineStatuses_descriptor;
    }
    ...
    // Construct using im.turms.turms.pojo.response.UsersOnlineStatuses.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.UsersOnlineStatuses getDefaultInstanceForType() {
      return im.turms.turms.pojo.response.UsersOnlineStatuses.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.turms.pojo.response.UsersOnlineStatuses build() {
      im.turms.turms.pojo.response.UsersOnlineStatuses result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.UsersOnlineStatuses buildPartial() {
      im.turms.turms.pojo.response.UsersOnlineStatuses result = new im.turms.turms.pojo.response.UsersOnlineStatuses(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.response.UsersOnlineStatuses) {
        return mergeFrom((im.turms.turms.pojo.response.UsersOnlineStatuses)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.response.UsersOnlineStatuses other) {
      if (other == im.turms.turms.pojo.response.UsersOnlineStatuses.getDefaultInstance()) return this;
      if (userStatusesBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.response.UsersOnlineStatuses parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.response.UsersOnlineStatuses) e.getUnfinishedMessage();
    ...
    private void ensureUserStatusesIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        userStatuses_ = new java.util.ArrayList<im.turms.turms.pojo.dto.UserStatusDetail>(userStatuses_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.UserStatusDetail, im.turms.turms.pojo.dto.UserStatusDetail.Builder, im.turms.turms.pojo.dto.UserStatusDetailOrBuilder> userStatusesBuilder_;
    ...
    public Builder setUserStatuses(
        int index, im.turms.turms.pojo.dto.UserStatusDetail value) {
      if (userStatusesBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setUserStatuses(
        int index, im.turms.turms.pojo.dto.UserStatusDetail.Builder builderForValue) {
      if (userStatusesBuilder_ == null) {
        ensureUserStatusesIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
     */
    public Builder addUserStatuses(im.turms.turms.pojo.dto.UserStatusDetail value) {
      if (userStatusesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addUserStatuses(
        im.turms.turms.pojo.dto.UserStatusDetail.Builder builderForValue) {
      if (userStatusesBuilder_ == null) {
        ensureUserStatusesIsMutable();
    ...
    public Builder addAllUserStatuses(
        java.lang.Iterable<? extends im.turms.turms.pojo.dto.UserStatusDetail> values) {
      if (userStatusesBuilder_ == null) {
        ensureUserStatusesIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
     */
    public im.turms.turms.pojo.dto.UserStatusDetail.Builder getUserStatusesBuilder(
        int index) {
     ...
     * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
     */
    public im.turms.turms.pojo.dto.UserStatusDetail.Builder addUserStatusesBuilder() {
      return getUserStatusesFieldBuilder().addBuilder(
          im.turms.turms.pojo.dto.UserStatusDetail.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
     */
    public im.turms.turms.pojo.dto.UserStatusDetail.Builder addUserStatusesBuilder(
        int index) {
      return getUserStatusesFieldBuilder().addBuilder(
          index, im.turms.turms.pojo.dto.UserStatusDetail.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
     */
  ...
  private static final im.turms.turms.pojo.response.UsersOnlineStatuses DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.response.UsersOnlineStatuses();
  }

  public static im.turms.turms.pojo.response.UsersOnlineStatuses getDefaultInstance() {
