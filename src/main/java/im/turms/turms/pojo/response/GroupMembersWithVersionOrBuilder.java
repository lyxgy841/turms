...
public interface GroupMembersWithVersionOrBuilder extends
   ...
   */
  java.util.List<im.turms.turms.pojo.dto.GroupMember> 
      getGroupMembersList();
  /**
   * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
   */
  im.turms.turms.pojo.dto.GroupMember getGroupMembers(int index);
  /**
   * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
   */
   ...
   * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
   */
  java.util.List<? extends im.turms.turms.pojo.dto.GroupMemberOrBuilder> 
      getGroupMembersOrBuilderList();
  /**
   * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
   */
  im.turms.turms.pojo.dto.GroupMemberOrBuilder getGroupMembersOrBuilder(
      int index);
