...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userRelationships_ = new java.util.ArrayList<im.turms.turms.pojo.dto.UserRelationship>();
              mutable_bitField0_ |= 0x00000001;
            }
            userRelationships_.add(
                input.readMessage(im.turms.turms.pojo.dto.UserRelationship.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return im.turms.turms.pojo.response.UserRelationshipsWithVersionOuterClass.internal_static_im_turms_proto_UserRelationshipsWithVersion_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.response.UserRelationshipsWithVersionOuterClass.internal_static_im_turms_proto_UserRelationshipsWithVersion_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.turms.pojo.response.UserRelationshipsWithVersion.class, im.turms.turms.pojo.response.UserRelationshipsWithVersion.Builder.class);
  }

  public static final int USER_RELATIONSHIPS_FIELD_NUMBER = 1;
  private java.util.List<im.turms.turms.pojo.dto.UserRelationship> userRelationships_;
  /**
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  public java.util.List<im.turms.turms.pojo.dto.UserRelationship> getUserRelationshipsList() {
   ...
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  public im.turms.turms.pojo.dto.UserRelationship getUserRelationships(int index) {
    return userRelationships_.get(index);
  }
  /**
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  public im.turms.turms.pojo.dto.UserRelationshipOrBuilder getUserRelationshipsOrBuilder(
      int index) {
    return userRelationships_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.response.UserRelationshipsWithVersion)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.response.UserRelationshipsWithVersion other = (im.turms.turms.pojo.response.UserRelationshipsWithVersion) obj;
  ...
  public static im.turms.turms.pojo.response.UserRelationshipsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.UserRelationshipsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.turms.pojo.response.UserRelationshipsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.UserRelationshipsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.response.UserRelationshipsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.turms.turms.pojo.response.UserRelationshipsWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.response.UserRelationshipsWithVersion prototype) {
  ...
  public static final class Builder extends
      ...
      im.turms.turms.pojo.response.UserRelationshipsWithVersionOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return im.turms.turms.pojo.response.UserRelationshipsWithVersionOuterClass.internal_static_im_turms_proto_UserRelationshipsWithVersion_descriptor;
    }
    ...
    // Construct using im.turms.turms.pojo.response.UserRelationshipsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.UserRelationshipsWithVersion getDefaultInstanceForType() {
      return im.turms.turms.pojo.response.UserRelationshipsWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.turms.pojo.response.UserRelationshipsWithVersion build() {
      im.turms.turms.pojo.response.UserRelationshipsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.UserRelationshipsWithVersion buildPartial() {
      im.turms.turms.pojo.response.UserRelationshipsWithVersion result = new im.turms.turms.pojo.response.UserRelationshipsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.response.UserRelationshipsWithVersion) {
        return mergeFrom((im.turms.turms.pojo.response.UserRelationshipsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.response.UserRelationshipsWithVersion other) {
      if (other == im.turms.turms.pojo.response.UserRelationshipsWithVersion.getDefaultInstance()) return this;
      if (userRelationshipsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.response.UserRelationshipsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.response.UserRelationshipsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureUserRelationshipsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        userRelationships_ = new java.util.ArrayList<im.turms.turms.pojo.dto.UserRelationship>(userRelationships_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.UserRelationship, im.turms.turms.pojo.dto.UserRelationship.Builder, im.turms.turms.pojo.dto.UserRelationshipOrBuilder> userRelationshipsBuilder_;
    ...
    public Builder setUserRelationships(
        int index, im.turms.turms.pojo.dto.UserRelationship value) {
      if (userRelationshipsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setUserRelationships(
        int index, im.turms.turms.pojo.dto.UserRelationship.Builder builderForValue) {
      if (userRelationshipsBuilder_ == null) {
        ensureUserRelationshipsIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    public Builder addUserRelationships(im.turms.turms.pojo.dto.UserRelationship value) {
      if (userRelationshipsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addUserRelationships(
        im.turms.turms.pojo.dto.UserRelationship.Builder builderForValue) {
      if (userRelationshipsBuilder_ == null) {
        ensureUserRelationshipsIsMutable();
    ...
    public Builder addAllUserRelationships(
        java.lang.Iterable<? extends im.turms.turms.pojo.dto.UserRelationship> values) {
      if (userRelationshipsBuilder_ == null) {
        ensureUserRelationshipsIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    public im.turms.turms.pojo.dto.UserRelationship.Builder getUserRelationshipsBuilder(
        int index) {
     ...
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    public im.turms.turms.pojo.dto.UserRelationship.Builder addUserRelationshipsBuilder() {
      return getUserRelationshipsFieldBuilder().addBuilder(
          im.turms.turms.pojo.dto.UserRelationship.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    public im.turms.turms.pojo.dto.UserRelationship.Builder addUserRelationshipsBuilder(
        int index) {
      return getUserRelationshipsFieldBuilder().addBuilder(
          index, im.turms.turms.pojo.dto.UserRelationship.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
  ...
  private static final im.turms.turms.pojo.response.UserRelationshipsWithVersion DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.response.UserRelationshipsWithVersion();
  }

  public static im.turms.turms.pojo.response.UserRelationshipsWithVersion getDefaultInstance() {
