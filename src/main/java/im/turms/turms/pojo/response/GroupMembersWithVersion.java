...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              groupMembers_ = new java.util.ArrayList<im.turms.turms.pojo.dto.GroupMember>();
              mutable_bitField0_ |= 0x00000001;
            }
            groupMembers_.add(
                input.readMessage(im.turms.turms.pojo.dto.GroupMember.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return im.turms.turms.pojo.response.GroupMembersWithVersionOuterClass.internal_static_im_turms_proto_GroupMembersWithVersion_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.response.GroupMembersWithVersionOuterClass.internal_static_im_turms_proto_GroupMembersWithVersion_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.turms.pojo.response.GroupMembersWithVersion.class, im.turms.turms.pojo.response.GroupMembersWithVersion.Builder.class);
  }

  public static final int GROUP_MEMBERS_FIELD_NUMBER = 1;
  private java.util.List<im.turms.turms.pojo.dto.GroupMember> groupMembers_;
  /**
   * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
   */
  public java.util.List<im.turms.turms.pojo.dto.GroupMember> getGroupMembersList() {
    return groupMembers_;
  }
  /**
   * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
   */
  public java.util.List<? extends im.turms.turms.pojo.dto.GroupMemberOrBuilder> 
   ...
   * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
   */
  public im.turms.turms.pojo.dto.GroupMember getGroupMembers(int index) {
    return groupMembers_.get(index);
  }
  /**
   * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
   */
  public im.turms.turms.pojo.dto.GroupMemberOrBuilder getGroupMembersOrBuilder(
      int index) {
    return groupMembers_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.response.GroupMembersWithVersion)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.response.GroupMembersWithVersion other = (im.turms.turms.pojo.response.GroupMembersWithVersion) obj;
  ...
  public static im.turms.turms.pojo.response.GroupMembersWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.GroupMembersWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.turms.pojo.response.GroupMembersWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.response.GroupMembersWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.response.GroupMembersWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.turms.turms.pojo.response.GroupMembersWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.response.GroupMembersWithVersion prototype) {
  ...
  public static final class Builder extends
      ...
      im.turms.turms.pojo.response.GroupMembersWithVersionOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return im.turms.turms.pojo.response.GroupMembersWithVersionOuterClass.internal_static_im_turms_proto_GroupMembersWithVersion_descriptor;
    }
    ...
    // Construct using im.turms.turms.pojo.response.GroupMembersWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.GroupMembersWithVersion getDefaultInstanceForType() {
      return im.turms.turms.pojo.response.GroupMembersWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.turms.pojo.response.GroupMembersWithVersion build() {
      im.turms.turms.pojo.response.GroupMembersWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.response.GroupMembersWithVersion buildPartial() {
      im.turms.turms.pojo.response.GroupMembersWithVersion result = new im.turms.turms.pojo.response.GroupMembersWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.response.GroupMembersWithVersion) {
        return mergeFrom((im.turms.turms.pojo.response.GroupMembersWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.response.GroupMembersWithVersion other) {
      if (other == im.turms.turms.pojo.response.GroupMembersWithVersion.getDefaultInstance()) return this;
      if (groupMembersBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.response.GroupMembersWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.response.GroupMembersWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureGroupMembersIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        groupMembers_ = new java.util.ArrayList<im.turms.turms.pojo.dto.GroupMember>(groupMembers_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.GroupMember, im.turms.turms.pojo.dto.GroupMember.Builder, im.turms.turms.pojo.dto.GroupMemberOrBuilder> groupMembersBuilder_;
    ...
    public Builder setGroupMembers(
        int index, im.turms.turms.pojo.dto.GroupMember value) {
      if (groupMembersBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setGroupMembers(
        int index, im.turms.turms.pojo.dto.GroupMember.Builder builderForValue) {
      if (groupMembersBuilder_ == null) {
        ensureGroupMembersIsMutable();
     ...
     * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
     */
    public Builder addGroupMembers(im.turms.turms.pojo.dto.GroupMember value) {
      if (groupMembersBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addGroupMembers(
        im.turms.turms.pojo.dto.GroupMember.Builder builderForValue) {
      if (groupMembersBuilder_ == null) {
        ensureGroupMembersIsMutable();
    ...
    public Builder addAllGroupMembers(
        java.lang.Iterable<? extends im.turms.turms.pojo.dto.GroupMember> values) {
      if (groupMembersBuilder_ == null) {
        ensureGroupMembersIsMutable();
     ...
     * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
     */
    public im.turms.turms.pojo.dto.GroupMember.Builder getGroupMembersBuilder(
        int index) {
     ...
     * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
     */
    public im.turms.turms.pojo.dto.GroupMember.Builder addGroupMembersBuilder() {
      return getGroupMembersFieldBuilder().addBuilder(
          im.turms.turms.pojo.dto.GroupMember.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
     */
    public im.turms.turms.pojo.dto.GroupMember.Builder addGroupMembersBuilder(
        int index) {
      return getGroupMembersFieldBuilder().addBuilder(
          index, im.turms.turms.pojo.dto.GroupMember.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.GroupMember group_members = 1;</code>
     */
    public java.util.List<im.turms.turms.pojo.dto.GroupMember.Builder> 
         getGroupMembersBuilderList() {
      return getGroupMembersFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.turms.pojo.dto.GroupMember, im.turms.turms.pojo.dto.GroupMember.Builder, im.turms.turms.pojo.dto.GroupMemberOrBuilder> 
        getGroupMembersFieldBuilder() {
      if (groupMembersBuilder_ == null) {
  ...
  private static final im.turms.turms.pojo.response.GroupMembersWithVersion DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.response.GroupMembersWithVersion();
  }

  public static im.turms.turms.pojo.response.GroupMembersWithVersion getDefaultInstance() {
