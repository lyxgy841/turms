...
public interface GroupInvitationsWithVersionOrBuilder extends
     ...
     */
    java.util.List<im.turms.turms.pojo.bo.group.GroupInvitation>
    getGroupInvitationsList();

    /**
     * <code>repeated .im.turms.proto.GroupInvitation group_invitations = 1;</code>
     */
    im.turms.turms.pojo.bo.group.GroupInvitation getGroupInvitations(int index);
     ...
     * <code>repeated .im.turms.proto.GroupInvitation group_invitations = 1;</code>
     */
    java.util.List<? extends im.turms.turms.pojo.bo.group.GroupInvitationOrBuilder>
    getGroupInvitationsOrBuilderList();

    /**
     * <code>repeated .im.turms.proto.GroupInvitation group_invitations = 1;</code>
     */
    im.turms.turms.pojo.bo.group.GroupInvitationOrBuilder getGroupInvitationsOrBuilder(
            int index);
