...
private static final long serialVersionUID = 0L;
  ...
  private static final im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion();
  }

  private java.util.List<im.turms.turms.pojo.bo.user.UserRelationship> userRelationships_;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userRelationships_ = new java.util.ArrayList<im.turms.turms.pojo.bo.user.UserRelationship>();
              mutable_bitField0_ |= 0x00000001;
            }
            userRelationships_.add(
                    input.readMessage(im.turms.turms.pojo.bo.user.UserRelationship.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  getDescriptor() {
    return im.turms.turms.pojo.bo.user.UserRelationshipsWithVersionOuterClass.internal_static_im_turms_proto_UserRelationshipsWithVersion_descriptor;
  }

  public static im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion parseFrom(java.io.InputStream input)
          throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
  }

  public static im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion prototype) {
    return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
  }

  public static im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion getDefaultInstance() {
  ...
  internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.bo.user.UserRelationshipsWithVersionOuterClass.internal_static_im_turms_proto_UserRelationshipsWithVersion_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                    im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion.class, im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion.Builder.class);
  }

  /**
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  public java.util.List<im.turms.turms.pojo.bo.user.UserRelationship> getUserRelationshipsList() {
   ...
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  public java.util.List<? extends im.turms.turms.pojo.bo.user.UserRelationshipOrBuilder>
   ...
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  public im.turms.turms.pojo.bo.user.UserRelationship getUserRelationships(int index) {
   ...
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  public im.turms.turms.pojo.bo.user.UserRelationshipOrBuilder getUserRelationshipsOrBuilder(
          int index) {
    return userRelationships_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion other = (im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion) obj;
  ...
  @java.lang.Override
  public im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion getDefaultInstanceForType() {
    return DEFAULT_INSTANCE;
  }
  ...
  public static final class Builder extends
          ...
          im.turms.turms.pojo.bo.user.UserRelationshipsWithVersionOrBuilder {
    private java.util.List<im.turms.turms.pojo.bo.user.UserRelationship> userRelationships_ =
            java.util.Collections.emptyList();
    private com.google.protobuf.RepeatedFieldBuilderV3<
            im.turms.turms.pojo.bo.user.UserRelationship, im.turms.turms.pojo.bo.user.UserRelationship.Builder, im.turms.turms.pojo.bo.user.UserRelationshipOrBuilder> userRelationshipsBuilder_;

    // Construct using im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion build() {
      im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion buildPartial() {
      im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion result = new im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion) {
        return mergeFrom((im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion) other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion other) {
      if (other == im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion.getDefaultInstance()) return this;
      if (userRelationshipsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
      im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.bo.user.UserRelationshipsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureUserRelationshipsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        userRelationships_ = new java.util.ArrayList<im.turms.turms.pojo.bo.user.UserRelationship>(userRelationships_);
    ...
    public Builder setUserRelationships(
            int index, im.turms.turms.pojo.bo.user.UserRelationship value) {
      if (userRelationshipsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setUserRelationships(
            int index, im.turms.turms.pojo.bo.user.UserRelationship.Builder builderForValue) {
      if (userRelationshipsBuilder_ == null) {
        ensureUserRelationshipsIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    public Builder addUserRelationships(im.turms.turms.pojo.bo.user.UserRelationship value) {
      if (userRelationshipsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addUserRelationships(
            im.turms.turms.pojo.bo.user.UserRelationship.Builder builderForValue) {
      if (userRelationshipsBuilder_ == null) {
        ensureUserRelationshipsIsMutable();
    ...
    public Builder addAllUserRelationships(
            java.lang.Iterable<? extends im.turms.turms.pojo.bo.user.UserRelationship> values) {
      if (userRelationshipsBuilder_ == null) {
        ensureUserRelationshipsIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    public im.turms.turms.pojo.bo.user.UserRelationship.Builder getUserRelationshipsBuilder(
            int index) {
     ...
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    public im.turms.turms.pojo.bo.user.UserRelationship.Builder addUserRelationshipsBuilder() {
      return getUserRelationshipsFieldBuilder().addBuilder(
              im.turms.turms.pojo.bo.user.UserRelationship.getDefaultInstance());
    }
    ...
    public im.turms.turms.pojo.bo.user.UserRelationship.Builder addUserRelationshipsBuilder(
            int index) {
      return getUserRelationshipsFieldBuilder().addBuilder(
              index, im.turms.turms.pojo.bo.user.UserRelationship.getDefaultInstance());
    }

    /**
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    public java.util.List<im.turms.turms.pojo.bo.user.UserRelationship.Builder>
    getUserRelationshipsBuilderList() {
      return getUserRelationshipsFieldBuilder().getBuilderList();
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
            im.turms.turms.pojo.bo.user.UserRelationship, im.turms.turms.pojo.bo.user.UserRelationship.Builder, im.turms.turms.pojo.bo.user.UserRelationshipOrBuilder>
    getUserRelationshipsFieldBuilder() {
      if (userRelationshipsBuilder_ == null) {
