...
private static final long serialVersionUID = 0L;
  ...
  private static final im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion();
  }

  private java.util.List<im.turms.turms.pojo.bo.user.UserFriendRequest> userFriendRequests_;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userFriendRequests_ = new java.util.ArrayList<im.turms.turms.pojo.bo.user.UserFriendRequest>();
              mutable_bitField0_ |= 0x00000001;
            }
            userFriendRequests_.add(
                    input.readMessage(im.turms.turms.pojo.bo.user.UserFriendRequest.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  getDescriptor() {
    return im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersionOuterClass.internal_static_im_turms_proto_UserFriendRequestsWithVersion_descriptor;
  }

  public static im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion parseFrom(
  ...
  public static im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion parseFrom(java.io.InputStream input)
          throws java.io.IOException {
  ...
  public static im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
  }

  public static im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion prototype) {
    return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
  }

  public static im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion getDefaultInstance() {
  ...
  internalGetFieldAccessorTable() {
    return im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersionOuterClass.internal_static_im_turms_proto_UserFriendRequestsWithVersion_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                    im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion.class, im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion.Builder.class);
  }

  /**
   * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
   */
  public java.util.List<im.turms.turms.pojo.bo.user.UserFriendRequest> getUserFriendRequestsList() {
   ...
   * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
   */
  public java.util.List<? extends im.turms.turms.pojo.bo.user.UserFriendRequestOrBuilder>
   ...
   * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
   */
  public im.turms.turms.pojo.bo.user.UserFriendRequest getUserFriendRequests(int index) {
   ...
   * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
   */
  public im.turms.turms.pojo.bo.user.UserFriendRequestOrBuilder getUserFriendRequestsOrBuilder(
          int index) {
    return userFriendRequests_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion)) {
      return super.equals(obj);
    }
    im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion other = (im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion) obj;
  ...
  @java.lang.Override
  public im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion getDefaultInstanceForType() {
    return DEFAULT_INSTANCE;
  }
  ...
  public static final class Builder extends
          ...
          im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersionOrBuilder {
    private java.util.List<im.turms.turms.pojo.bo.user.UserFriendRequest> userFriendRequests_ =
            java.util.Collections.emptyList();
    private com.google.protobuf.RepeatedFieldBuilderV3<
            im.turms.turms.pojo.bo.user.UserFriendRequest, im.turms.turms.pojo.bo.user.UserFriendRequest.Builder, im.turms.turms.pojo.bo.user.UserFriendRequestOrBuilder> userFriendRequestsBuilder_;

    // Construct using im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion build() {
      im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion buildPartial() {
      im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion result = new im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion) {
        return mergeFrom((im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion) other);
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion other) {
      if (other == im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion.getDefaultInstance()) return this;
      if (userFriendRequestsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
      im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.bo.user.UserFriendRequestsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureUserFriendRequestsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        userFriendRequests_ = new java.util.ArrayList<im.turms.turms.pojo.bo.user.UserFriendRequest>(userFriendRequests_);
    ...
    public Builder setUserFriendRequests(
            int index, im.turms.turms.pojo.bo.user.UserFriendRequest value) {
      if (userFriendRequestsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setUserFriendRequests(
            int index, im.turms.turms.pojo.bo.user.UserFriendRequest.Builder builderForValue) {
      if (userFriendRequestsBuilder_ == null) {
        ensureUserFriendRequestsIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public Builder addUserFriendRequests(im.turms.turms.pojo.bo.user.UserFriendRequest value) {
      if (userFriendRequestsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addUserFriendRequests(
            im.turms.turms.pojo.bo.user.UserFriendRequest.Builder builderForValue) {
      if (userFriendRequestsBuilder_ == null) {
        ensureUserFriendRequestsIsMutable();
    ...
    public Builder addAllUserFriendRequests(
            java.lang.Iterable<? extends im.turms.turms.pojo.bo.user.UserFriendRequest> values) {
      if (userFriendRequestsBuilder_ == null) {
        ensureUserFriendRequestsIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public im.turms.turms.pojo.bo.user.UserFriendRequest.Builder getUserFriendRequestsBuilder(
            int index) {
     ...
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public im.turms.turms.pojo.bo.user.UserFriendRequest.Builder addUserFriendRequestsBuilder() {
      return getUserFriendRequestsFieldBuilder().addBuilder(
              im.turms.turms.pojo.bo.user.UserFriendRequest.getDefaultInstance());
    }
    ...
    public im.turms.turms.pojo.bo.user.UserFriendRequest.Builder addUserFriendRequestsBuilder(
            int index) {
      return getUserFriendRequestsFieldBuilder().addBuilder(
              index, im.turms.turms.pojo.bo.user.UserFriendRequest.getDefaultInstance());
    }

    /**
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public java.util.List<im.turms.turms.pojo.bo.user.UserFriendRequest.Builder>
    getUserFriendRequestsBuilderList() {
      return getUserFriendRequestsFieldBuilder().getBuilderList();
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
            im.turms.turms.pojo.bo.user.UserFriendRequest, im.turms.turms.pojo.bo.user.UserFriendRequest.Builder, im.turms.turms.pojo.bo.user.UserFriendRequestOrBuilder>
    getUserFriendRequestsFieldBuilder() {
      if (userFriendRequestsBuilder_ == null) {
