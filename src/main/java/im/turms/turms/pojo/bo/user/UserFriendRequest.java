...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public im.turms.turms.pojo.bo.user.UserFriendRequest getDefaultInstanceForType() {
      return im.turms.turms.pojo.bo.user.UserFriendRequest.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.turms.pojo.bo.user.UserFriendRequest build() {
      im.turms.turms.pojo.bo.user.UserFriendRequest result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.bo.user.UserFriendRequest buildPartial() {
      im.turms.turms.pojo.bo.user.UserFriendRequest result = new im.turms.turms.pojo.bo.user.UserFriendRequest(this);
      if (idBuilder_ == null) {
        result.id_ = id_;
      } else {
    ...
    public Builder mergeFrom(im.turms.turms.pojo.bo.user.UserFriendRequest other) {
      if (other == im.turms.turms.pojo.bo.user.UserFriendRequest.getDefaultInstance()) return this;
      if (other.hasId()) {
        mergeId(other.getId());
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.bo.user.UserFriendRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.bo.user.UserFriendRequest) e.getUnfinishedMessage();
