...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public im.turms.turms.pojo.bo.message.Message getDefaultInstanceForType() {
      return im.turms.turms.pojo.bo.message.Message.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.turms.pojo.bo.message.Message build() {
      im.turms.turms.pojo.bo.message.Message result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.bo.message.Message buildPartial() {
      im.turms.turms.pojo.bo.message.Message result = new im.turms.turms.pojo.bo.message.Message(this);
    ...
    public Builder mergeFrom(im.turms.turms.pojo.bo.message.Message other) {
      if (other == im.turms.turms.pojo.bo.message.Message.getDefaultInstance()) return this;
      if (other.hasId()) {
        mergeId(other.getId());
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.bo.message.Message parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.bo.message.Message) e.getUnfinishedMessage();
