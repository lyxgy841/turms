...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              messagesWithTotalList_ = new java.util.ArrayList<im.turms.turms.pojo.bo.message.MessagesWithTotal>();
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public im.turms.turms.pojo.bo.message.MessagesWithTotalList build() {
      im.turms.turms.pojo.bo.message.MessagesWithTotalList result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.turms.pojo.bo.message.MessagesWithTotalList buildPartial() {
      im.turms.turms.pojo.bo.message.MessagesWithTotalList result = new im.turms.turms.pojo.bo.message.MessagesWithTotalList(this);
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.turms.pojo.bo.message.MessagesWithTotalList parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.turms.pojo.bo.message.MessagesWithTotalList) e.getUnfinishedMessage();
     ...
     * <code>repeated .im.turms.proto.MessagesWithTotal messages_with_total_list = 1;</code>
     */
    public Builder addMessagesWithTotalList(im.turms.turms.pojo.bo.message.MessagesWithTotal value) {
      if (messagesWithTotalListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
