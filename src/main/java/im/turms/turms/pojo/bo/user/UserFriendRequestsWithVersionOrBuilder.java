...
public interface UserFriendRequestsWithVersionOrBuilder extends
     ...
     */
    java.util.List<im.turms.turms.pojo.bo.user.UserFriendRequest>
    getUserFriendRequestsList();

    /**
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    im.turms.turms.pojo.bo.user.UserFriendRequest getUserFriendRequests(int index);
     ...
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    java.util.List<? extends im.turms.turms.pojo.bo.user.UserFriendRequestOrBuilder>
    getUserFriendRequestsOrBuilderList();

    /**
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    im.turms.turms.pojo.bo.user.UserFriendRequestOrBuilder getUserFriendRequestsOrBuilder(
            int index);
